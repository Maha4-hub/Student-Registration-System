document.addEventListener('DOMContentLoaded', function() {
    ...
    const saveToLocalStorage = () => {
       ...
       form.reset(); // Clear the form after saving to local storage
    };
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!isValidContact(contact)) {
            showError(document.getElementById('contactNo'), 'Contact number should be 10 digits and start with 6, 7, 8, or 9');
            valid = false;
        } else {
